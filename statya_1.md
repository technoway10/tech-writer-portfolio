...
*   **Даты:** После согласования даты выезда инженер устанавливает ее в карточке.
...
2.  **Планирование.** Инженер забирает карточку в «Оценку и планирование» и первым делом **назначает себя участником**, показывая, что задача в работе. После звонка клиенту он, часто прямо со смартфона, устанавливает согласованную **дату выезда через функцию «Даты»**.
3.  **День выезда.** Утром инженер заходит в Trello, смотрит на карточки, у которых «Даты» наступает сегодня, и **переносит именно их** в колонку «К выполнению / На выезде». Это его четкий план на день.
